...
static constexpr int     BRIGHTNESS        = 150;    // 0-255 PWM for backlight; ignored if PIN_TFT_BL < 0
static constexpr uint8_t DIM_BRIGHTNESS    = 50;      // PWM when dimmed — low but not off
